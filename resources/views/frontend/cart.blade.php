...
<div class="container my-5">
    <div class="card shadow ">
        ...
        <div class="card-body">
            ...
            <div class="row product_data">
                <div class="col-md-2 my-auto">
                    <img class="image" src="{{ asset('assets/uploads/products/'.$item->products->image) }}" width="100px" alt="Image Here">
                </div>
        ...
        <div class="card-footer">
            ...
            <a href="{{ url('checkout') }}" class="btn btn-outline-success float-end">Checkuot Now</a>
            </h6>
        </div>
        @else
